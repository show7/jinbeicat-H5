<template>
	<div class="tab-second">
		<div class="list-content" id="app-4">
...
<script>
    ...
    export default{
        ...
        mounted:function(){
            ...
            var invest=this.queryAjax('qapi/product/list.do','post',{proType:"BANK_BRIDGE,HOUSE_MORTGAGE,CAR_MORTAGE,PLEDGE",size:10,pageNo:this.nextPage},token);
            ...
            // console.log(listArray)
                for(var i=0;i<listArray.length;i++){
                    ...
                    console.log(listArray[i].activitys)
                    //获取列表页的pid进行传递
